...
var Game = {
  ...
  gameOver: function(){
  	...
  	var message2 = "점수: " + Game.score;
  	var message3 = "다시 시작하려면 스페이스바(Spacebar)를 눌러주세요.";
  	this.pause();
  ...
  updateScore: function(){
  	...
  	this.ctx.fillText("점수:  " + this.score, 8, 20);
  	this.ctx.fillText("레벨:  " + (this.maxLives - this.life), 8, 40);
  },
